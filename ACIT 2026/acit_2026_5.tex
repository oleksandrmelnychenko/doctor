...
{\scriptsize Abbreviations: Bal., balanced; Aug., augmented; Part., partial; Passive, resistance to passive/offline guessing only after record compromise; IC, ideal-cipher model; ROM, random-oracle model; UC, universally composable.}
\end{table}
...
\subsection{Computational Security Argument in the Post-Quantum Model}
...
\caption{Transcript-bound hybrid key schedule. Classical 4DH material and the ML-KEM shared secret are concatenated into a single transcript-salted HKDF-Extract, so the derived keys depend jointly on both layers.}
...
\subsection{Scalability in Large Distributed Systems}
...
\bibitem{shibeeb2023}
A.~K.~Shibeeb, M.~H.~Ahmed, and S.~Albermany, ``An efficient image encryption method based on enhanced Josephus problem and a non-invertible economic map,'' \emph{International Journal of Computing}, vol.~22, no.~4, pp.~493--501, 2023. doi:~\url{https://doi.org/10.47839/ijc.22.4.3357}.

\bibitem{bykovyy2007}
P.~E.~Bykovyy, V.~D.~Kochan, A.~O.~Sachenko, and G.~Markowsky, ``Genetic algorithm implementation for perimeter security systems CAD,'' in \emph{Proc. 4th IEEE Workshop on Intelligent Data Acquisition and Advanced Computing Systems: Technology and Applications}, Dortmund, Germany, 2007, pp.~634--638. doi:~\url{https://doi.org/10.1109/IDAACS.2007.4488498}.

\bibitem{gorbenko2019}
Y.~Gorbenko, A.~Kiian, A.~Pushkar'ov, O.~Korneiko, S.~Smirnov, and T.~Kuznetsova, ``Code-based hybrid cryptosystem: Comparative studies and analysis of efficiency,'' \emph{International Journal of Computing}, vol.~18, no.~4, pp.~372--380, 2019. doi:~\url{https://doi.org/10.47839/ijc.18.4.1608}.

\bibitem{bykovyy2008}
P.~E.~Bykovyy, Y.~Pigovsky, V.~D.~Kochan, A.~O.~Sachenko, G.~Markowsky, and S.~Aksoy, ``Genetic algorithm implementation for distributed security systems optimization,'' in \emph{Proc. IEEE Int. Conf. Computational Intelligence for Measurement Systems and Applications}, Istanbul, Turkey, 2008, pp.~120--124. doi:~\url{https://doi.org/10.1109/CIMSA.2008.4595845}.

\bibitem{mrena2024}
M.~Mrena and M.~Kvassay, ``Application of binary decision diagrams in time-dependent reliability analysis,'' \emph{International Journal of Computing}, vol.~23, no.~3, pp.~360--370, 2024. doi:~\url{https://doi.org/10.47839/ijc.23.3.3654}.

\bibitem{sachenko2009}
A.~Sachenko, A.~Banasik, and A.~Kapczy\'nski, ``The concept of application of fuzzy logic in biometric authentication systems,'' in \emph{Proc. Int. Workshop on Computational Intelligence in Security for Information Systems (CISIS'08)}, Advances in Soft Computing, vol.~53, Springer, 2009, pp.~274--279. doi:~\url{https://doi.org/10.1007/978-3-540-88181-0_35}.

\bibitem{touil2024ssh}
H.~Touil, F.~Hdioud, N.~El~Akkad, and K.~Satori, ``The security of SSH protocol public key sharing in the post-quantum era,'' \emph{International Journal of Computing}, vol.~23, no.~3, pp.~317--323, 2024. doi:~\url{https://doi.org/10.47839/ijc.23.3.3650}.

\bibitem{connolly2003}
G.~Connolly, A.~Sachenko, and G.~Markowsky, ``Distributed traceroute approach to geographically locating IP devices,'' in \emph{Proc. 2nd IEEE Int. Workshop on Intelligent Data Acquisition and Advanced Computing Systems: Technology and Applications}, Lviv, Ukraine, 2003, pp.~128--131. doi:~\url{https://doi.org/10.1109/IDAACS.2003.1249532}.

\bibitem{lehominova2024}
S.~Lehominova, M.~Zaporozhchenko, Y.~Shchavinsky, T.~Muzhanova, V.~Tyshchenko, and M.~Yushchenko, ``Methodology for determining means of monitoring information security by the method of expert assessment,'' \emph{International Journal of Computing}, vol.~23, no.~4, pp.~681--691, 2024. doi:~\url{https://doi.org/10.47839/ijc.23.4.3770}.
