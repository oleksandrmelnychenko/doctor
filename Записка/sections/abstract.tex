% ============================================================
%  АНОТАЦІЯ (укр) + ABSTRACT (eng) + СПИСОК ПУБЛІКАЦІЙ
...
\noindent\textbf{Ключові слова:} приватний контекстний захист, оцінка інформаційного ризику, контекстна безпека месенджера, наскрізне шифрування, постквантова криптографія, OPAQUE, augmented PAKE, ML-KEM-768, серверно-сліпий канал нагляду, policy-aware safety-рішення, відтворюваність, інформаційна технологія.
