...
boundary~\cite{albertini2022,koch2025}. Parser differentials have the same
...
For every nonempty suffix \(z\) that an authorizing parser leaves after the
original terminal point,
\begin{equation}
  \mathsf{Parse}_{p,v,k}(y\parallel z)=\rho
  \land \rho.t=|y|<|y\parallel z|
  \Longrightarrow
